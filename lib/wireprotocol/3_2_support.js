...
var executeWrite = function(pool, bson, type, opsField, ns, ops, options, callback) {
  ...
  qh_decorateShellSessionAndTransaction(writeCommand, options);
...
WireProtocol.prototype.getMore = function(
  ...
  qh_decorateShellSessionAndTransaction(getMoreCmd, cursorState.cmd);
...
WireProtocol.prototype.command = function(bson, ns, cmd, cursorState, topology, options) {
  ...
  qh_decorateShellSessionAndTransaction(query.query,cmd); //setupCommand had done it
  ...
  //console.log("WireProtocol.prototype.command", JSON.stringify(query.query || query.$query))
  return query;
};
...
var executeFindCommand = function(bson, ns, cmd, cursorState, topology, options) {
  ...
  //added by qinghai
  qh_decorateShellSessionAndTransaction(findCmd, cmd);
...
var setupCommand = function(bson, ns, cmd, cursorState, topology, options) {
  ...
  qh_decorateShellSessionAndTransaction(finalCmd, cmd);
